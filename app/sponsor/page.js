  ...
  return (
    <main>
      <section className="max-w-7xl mx-auto py-8 px-10 bg-white">
          ...
          <ol>
            <li>
              ...
              <ul>
                ...
                <li>
                  Logo placement on all event materials, website, and televised
                  broadcasts.
                </li>
                <li>
            ...
            <li>
              ...
              <ul>
                <li>
                  Prominent logo placement on website, and televised broadcasts.
                </li>
                <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  Mentions in social media campaigns and promotional activities.
                </li>
                <li>
                  Complimentary booth space at the event venue for brand
                  promotion.
            ...
            <li>
              ...
              <p>
                ...
                discuss how we can tailor a sponsorship package that aligns with
                your objectives
              </p>
            </li>
          </ol>
        ...
        <div>
          <h2 className="py-10 text-xl font-bold">How to Become a Sponsor:</h2>
          <p>
