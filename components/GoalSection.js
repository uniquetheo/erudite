  ...
  return (
    <section className="max-w-7xl mx-auto p-4 sm:p-8 bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 bg-slate-800 sm:p-8 p-2">
        <div className="bg-red-100 h-60 flex flex-col justify-center items-center ">
          <Image
        ...
        <div className="bg-red-100 h-60 flex flex-col justify-center items-center  p-2">
          <h3 className="text-base font-bold">Our Goal</h3>
          <p>{goalText[0].text}</p>
        </div>
        <div className="bg-red-100 sm:h-60 flex flex-col justify-center items-center  h-61 p-2">
